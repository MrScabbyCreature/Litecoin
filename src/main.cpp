...
uint256 hashGenesisBlock("0xf32553456529e19460ad34f4035b178638f1c47d9306dcbabef9cfa30268b698");
...
static const int64 nTargetSpacing = 1 * 60; // Litecoin: 2.5 minutes
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is Abhor coin. Parameterized by his roll number: 11640040";
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04dce705f705acd43308641b5d4fada8cd30d0ac0002ba3a50cc1d9dca3cbdfb851e728768384cd716d5e4fcee93272b3f7661f20e9ca4c40b5d6491f9e6f72928") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1556101514;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086584090;

        if (fTestNet)
        {
            block.nTime    = 1556101515;
        ...
        assert(block.hashMerkleRoot == uint256("0xa81254210d6548638a93ab8af793879193536db78f5ceadd5f03f933a04ba7b4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xc2, 0xb3, 0xd4 }; // Litecoin: increase each by adding 2 to bitcoin's value.
